    ...
    <form action="{{ route('daftar.post') }}" method="POST"
        ...
        <div class="space-y-4 w-full">
            ...
            <div class="flex items-center gap-20">
                ...
                <input type="text" name="kelas" class="rounded-lg bg-blue-100 px-3 py-1 flex-1">
            </div>
            ...
            <div class="flex items-center gap-20">
                ...
                <div class="relative flex-1">
                    ...
                    <span onclick="togglePassword()" class="absolute right-3 top-1 cursor-pointer select-none">👁</span>
                </div>
            </div>
